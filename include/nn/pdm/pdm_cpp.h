 ...
 */
      uint32_t
      Initialize() asm("Initialize__Q2_2nn3pdmFv");

      /**
 * Finalize PDM.
 */
      void
      Finalize() asm("Finalize__Q2_2nn3pdmFv");

      /**
 * Close all opened PDM Files.
 */
      void
      CloseAllFiles() asm("CloseAllFiles__Q2_2nn3pdmFv");
 ...
 */
      uint32_t
      Convert(uint32_t userId) asm("Convert__Q2_2nn3pdmFi");
 ...
 */
      uint32_t
      WaitForConvertDone() asm("WaitForConvertDone__Q2_2nn3pdmFv");
 ...
 */
      uint32_t
      GetPlayDiaryMaxLength(uint32_t *outMaxLength) asm("GetPlayDiaryMaxLength__Q2_2nn3pdmFPi");
 ...
 */
      uint32_t
      GetPlayDiaryLength(uint32_t *outLength, uint32_t userId) asm("GetPlayDiaryLength__Q2_2nn3pdmFPii");
 ...
 */
      uint32_t
      GetPlayDiaryStart(uint32_t *outStart, uint32_t userId) asm("GetPlayDiaryStart__Q2_2nn3pdmFPii");
 ...
 */
      uint32_t
      GetPlayDiary(uint32_t *outAmount, PlayDiary *outPlayDiaries, uint32_t userId, uint32_t amount) asm("GetPlayDiary__Q2_2nn3pdmFPiPQ3_2nn3pdm9PlayDiaryiT3");
 ...
 */
      uint32_t
      GetPlayDiary(PlayDiary *outPlayDiaries, uint32_t userId, uint32_t amount) asm("GetPlayDiary__Q2_2nn3pdmFPQ3_2nn3pdm9PlayDiaryiT2");
 ...
 */
      uint32_t
      GetPlayEventMaxLength(uint32_t *outMaxLength) asm("GetPlayEventMaxLength__Q2_2nn3pdmFPi");
 ...
 */
      uint32_t
      GetPlayEvent(uint32_t *outAmount, PlayEvent *outPlayEvents, uint32_t userId, uint32_t amount) asm("GetPlayEvent__Q2_2nn3pdmFPiPQ3_2nn3pdm9PlayEventiT3");
 ...
 */
      uint32_t
      GetPlayLogMaxLength(uint32_t *outMaxLength) asm("GetPlayLogMaxLength__Q2_2nn3pdmFPi");
 ...
 */
      uint32_t
      GetPlayLogLength(uint32_t *outLength, uint32_t userId) asm("GetPlayLogLength__Q2_2nn3pdmFPii");
 ...
 */
      uint32_t
      GetPlayLogStart(uint32_t *outStart, uint32_t userId) asm("GetPlayLogStart__Q2_2nn3pdmFPii");
 ...
 */
      uint32_t
      GetPlayLog(uint32_t *outAmount, PlayLog *outPlayLogs, uint32_t userId, uint32_t amount) asm("GetPlayLog__Q2_2nn3pdmFPiPQ3_2nn3pdm7PlayLogiT3");
 ...
 */
      uint32_t
      GetPlayLog(PlayLog *outPlayLogs, uint32_t userId, uint32_t amount) asm("GetPlayLog__Q2_2nn3pdmFPQ3_2nn3pdm7PlayLogiT2");
 ...
 */
      uint32_t
      GetPlayStatsMaxLength(uint32_t *outMaxLength) asm("GetPlayStatsMaxLength__Q2_2nn3pdmFPi");
 ...
 */
      uint32_t
      GetPlayStatsLength(uint32_t *outLength, uint32_t userId) asm("GetPlayStatsLength__Q2_2nn3pdmFPii");
 ...
 */
      uint32_t
      GetPlayStatsOfTitleId(PlayStats *outPlayStats, uint32_t userId, uint64_t titleId) asm("GetPlayStatsOfTitleId__Q2_2nn3pdmFPQ3_2nn3pdm9PlayStatsiUL");
 ...
 */
      uint32_t
      GetPlayStats(uint32_t *outAmount, PlayStats *outPlayStats, uint32_t userId, uint32_t amount) asm("GetPlayStats__Q2_2nn3pdmFPiPQ3_2nn3pdm9PlayStatsiT3");
 ...
 */
      uint32_t
      GetPlayStats(PlayStats *outPlayStats, uint32_t userId, uint32_t amount) asm("GetPlayStats__Q2_2nn3pdmFPQ3_2nn3pdm9PlayStatsiT2");

      void
      NotifySetTimeBeginEvent() asm("NotifySetTimeBeginEvent__Q2_2nn3pdmFv");

      void
      NotifySetTimeEndEvent() asm("NotifySetTimeEndEvent__Q2_2nn3pdmFv");
