...
nn::Result
AllowToConnect()
   asm("AllowToConnect__Q3_2nn3uds4CafeFv");
...
nn::Result
AllowToSpectate()
   asm("AllowToSpectate__Q3_2nn3uds4CafeFv");
...
Attach(EndpointDescriptor *fd,
   ...
   asm("Attach__Q3_2nn3uds4CafeFPQ4_2nn3uds4Cafe18EndpointDescriptorUsUcUi");
 ...
 */
uint32_t
CreateLocalCommunicationId(uint32_t uniqueId,
                           bool unknown)
   asm("CreateLocalCommunicationId__Q3_2nn3uds4CafeFUib");
 ...
 */
nn::Result
CreateEndpoint(EndpointDescriptor *fd)
   asm("CreateEndpoint__Q3_2nn3uds4CafeFPQ4_2nn3uds4Cafe18EndpointDescriptor");
...
CreateNetwork(uint8_t id8,
              ...
              uint8_t channel)
   asm("CreateNetwork__Q3_2nn3uds4CafeFUcT1UiPCcT3T1");
...
CreateNetwork(uint8_t id8,
   ...
   asm("CreateNetwork__Q3_2nn3uds4CafeFUcT1UiPCcT3T1PCvT3");
...
CreateNetwork(uint8_t id8,
              ...
              const void *appData,
              uint32_t appDataSize)
   asm("CreateNetwork__Q3_2nn3uds4CafeFUcT1UiPCcT3bT1PCvT3");
 ...
 */
nn::Result
DestroyEndpoint(EndpointDescriptor *fd)
   asm("DestroyEndpoint__Q3_2nn3uds4CafeFPQ4_2nn3uds4Cafe18EndpointDescriptor");
...
nn::Result
DestroyNetwork()
   asm("DestroyNetwork__Q3_2nn3uds4CafeFv");
 ...
 */
nn::Result
DisallowToConnect(bool unknown)
   asm("DisallowToConnect__Q3_2nn3uds4CafeFb");
 ...
 */
nn::Result
EjectClient(uint16_t networkNodeId)
   asm("EjectClient__Q3_2nn3uds4CafeFUs");
...
nn::Result
EjectSpectator()
   asm("EjectSpectator__Q3_2nn3uds4CafeFv");
...
void
Finalize()
   asm("Finalize__Q3_2nn3uds4CafeFv");
...
GetApplicationDataFromBeacon(void *appData,
                             uint32_t *readSize,
                             uint32_t size)
   asm("GetApplicationDataFromBeacon__Q3_2nn3uds4CafeFPvPUiUi");
...
GetChannel(uint8_t *channel)
   asm("GetChannel__Q3_2nn3uds4CafeFPUc");
 ...
 */
nn::Result
GetNodeInformation(NodeInformation *info,
                   uint16_t networkNodeId)
...
Initialize(void *workMemory,
   ...
   asm("Initialize__Q3_2nn3uds4CafeFPvUi");
...
Initialize(void *workMemory,
   ...
   asm("Initialize__Q3_2nn3uds4CafeFPvUiPQ4_2nn3cfg3CTR8UserName");
...
PollStateChange(uint8_t flags)
   asm("PollStateChange__Q3_2nn3uds4CafeFUc");
...
ReceiveFrom(const EndpointDescriptor &fd,
            ...
            uint32_t size,
            uint8_t flags)
   asm("ReceiveFrom__Q3_2nn3uds4CafeFRCQ4_2nn3uds4Cafe18EndpointDescriptorPvPUiPUsUiUc");
...
Receive(const EndpointDescriptor &fd,
        ...
        uint32_t size,
        uint8_t flags)
   asm("Receive__Q3_2nn3uds4CafeFRCQ4_2nn3uds4Cafe18EndpointDescriptorPvPUiUiUc");
...
SendTo(const EndpointDescriptor &fd,
       ...
       uint8_t dataChannel,
       uint8_t flags)
   asm("SendTo__Q3_2nn3uds4CafeFRCQ4_2nn3uds4Cafe18EndpointDescriptorPCvUiUsUcT5");
 ...
 */
nn::Result
SetApplicationDataToBeacon(const void *appData,
                           uint32_t size)
   asm("SetApplicationDataToBeacon__Q3_2nn3uds4CafeFPCvUi");
} // namespace Cafe
