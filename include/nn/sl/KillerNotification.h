...
namespace nn::sl {
    ...
    struct WUT_PACKED KillerNotification {
        ...
        static nn::Result CheckEmptyValue(bool *u1, const KillerNotification *u2) {
            return __CPR81__CheckEmptyValue__Q3_2nn2sl18KillerNotificationSFPbPCQ3_2nn2slJ26J(u1, u2);
        }

        static void GetEmptyValue(KillerNotification *u1) {
            return __CPR76__GetEmptyValue__Q3_2nn2sl18KillerNotificationSFPQ3_2nn2slJ24J(u1);
        }
    };
