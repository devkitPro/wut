...
#define WUT_ACCESS(access_type, ptr_index) __attribute__ ((__access__(access_type, ptr_index)))
#define WUT_ACCESS_SIZED(access_type, ptr_index, size_index) __attribute__ ((__access__(access_type, ptr_index, size_index)))
#else // not __GNUC__ and not __clang__

#define WUT_DEPRECATED(reason)
#define WUT_FORMAT_PRINTF(fmt, args)
#define WUT_ACCESS(access_type, ptr_index)
#define WUT_ACCESS_SIZED(access_type, ptr_index, size_index)
