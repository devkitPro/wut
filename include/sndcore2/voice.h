...
WUT_CHECK_SIZE(enum AX_VOICE_FORMAT, 4);
...
WUT_CHECK_SIZE(enum AX_VOICE_LOOP, 4);
...
WUT_CHECK_SIZE(enum AX_VOICE_RENDERER, 4);
...
WUT_CHECK_SIZE(enum AX_VOICE_RATIO_RESULT, 4);
...
WUT_CHECK_SIZE(enum AX_VOICE_SRC_TYPE, 4);
...
WUT_CHECK_SIZE(enum AX_VOICE_STATE, 4);
...
WUT_CHECK_SIZE(enum AX_VOICE_TYPE, 4);
