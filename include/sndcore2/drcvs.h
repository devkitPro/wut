...
WUT_CHECK_SIZE(enum AX_DRC_VS_MODE, 4);
...
WUT_CHECK_SIZE(enum AX_DRC_VS_OUTPUT, 4);
...
WUT_CHECK_SIZE(enum AX_DRC_VS_LC, 4);
...
WUT_CHECK_SIZE(enum AX_DRC_VS_SPEAKER_POS, 4);
...
WUT_CHECK_SIZE(enum AX_DRC_VS_SURROUND_GAIN, 4);
